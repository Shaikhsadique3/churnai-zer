-- Create a function to update existing user data with dynamic insights
...
BEGIN
    ...
    LOOP
        ...
        reasons := ARRAY[]::TEXT[];
        actions := ARRAY[]::TEXT[];
        understanding_score := 85; -- Base score
        ...
        IF user_record.usage < 3 THEN
            ...
            understanding_score := understanding_score - 20;
        ELSIF user_record.usage < 8 THEN
            reasons := array_append(reasons, 'Below average engagement');
            understanding_score := understanding_score - 10;
        END IF;
        ...
        IF user_record.plan = 'Free' THEN
            ...
            understanding_score := understanding_score - 5;
        END IF;
        ...
        IF user_record.last_login < NOW() - INTERVAL '60 days' THEN
            ...
            understanding_score := understanding_score - 15;
        END IF;
        ...
        understanding_score := GREATEST(LEAST(understanding_score, 100), 30);
...
SELECT update_existing_user_insights();